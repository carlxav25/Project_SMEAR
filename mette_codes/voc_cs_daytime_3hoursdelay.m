...
scatter(mono_median_h(summer_idx,1),median_cs(summer_idx+1,1),50,datevec_voc(summer_idx,4),'filled');
...
[r_summer,p_summer]=corr(log10(mono_median_h(summer_idx,1)),log10(median_cs(summer_idx+1,1)),'rows','complete') %r is the linear correlation coefficient, p is the p-value 

x=mono_median_h(summer_idx,1);
y= median_cs(summer_idx,1);

% Gives the slope and the intercept 
...
figure;
hold on;
scatter(mono_median_h(summer_idx,1),median_cs(summer_idx+1,1),50,median_temp(summer_idx,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
figure;
hold on;
scatter(mono_median_h(summer_idx,1),median_cs(summer_idx+1,1),50,rh_median(summer_idx,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
figure;
hold on;
scatter(mono_median_h(summer_idx,1),median_cs(summer_idx+1,1),50,o3_median(summer_idx,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
[r_summer_O3,p_summer_O3]=corr(log10(mono_median_h(summer_idx,1)),log10(median_cs(summer_idx+1,1)),'rows','complete'); %r is the linear correlation coefficient, p is the p-value 
...
figure;
hold on;
scatter(mono_median_h(summer_idx,1),median_cs(summer_idx+1,1),50,nox_median(summer_idx,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
[r_summer_NOX,p_summer_NOX]=corr(log10(mono_median_h(summer_idx,1)),log10(median_cs(summer_idx+1,1)),'rows','complete'); %r is the linear correlation coefficient, p is the p-value 
...
figure;
hold on;
scatter(mono_median_summer(summer_idx_10_t,1),median_cs_summer(summer_idx_10_t+1,1),50,median_temp_summer(summer_idx_10_t,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
cb = colorbar;
ylabel(cb,'Temperature','fontsize',16,'fontweight','b')
[r_summer_t10,p_summer_t10]=corr(log10(mono_median_summer(summer_idx_10_t,1)),log10(median_cs_summer(summer_idx_10_t+1,1)),'rows','complete')

%20C
figure;
hold on;
scatter(mono_median_summer(summer_idx_20_t(1:end-1),1),median_cs_summer(summer_idx_20_t(2:end),1),50,median_temp_summer(summer_idx_20_t(1:end-1),1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
cb = colorbar;
ylabel(cb,'Temperature','fontsize',16,'fontweight','b')
[r_summer_t20,p_summer_t20]=corr(log10(mono_median_summer(summer_idx_20_t(1:end-1),1)),log10(median_cs_summer(summer_idx_20_t(2:end),1)),'rows','complete')

%30C
figure;
hold on;
scatter(mono_median_summer(summer_idx_30_t,1),median_cs_summer(summer_idx_30_t+1,1),50,median_temp_summer(summer_idx_30_t,1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
cb = colorbar;
ylabel(cb,'Temperature','fontsize',16,'fontweight','b')
[r_summer_t30,p_summer_t30]=corr(log10(mono_median_summer(summer_idx_30_t,1)),log10(median_cs_summer(summer_idx_30_t+1,1)),'rows','complete')
...
figure;
hold on;
scatter(mono_median_summer(idx_nox_summer(1:end-1),1),median_cs_summer(idx_nox_summer(2:end),1),50,nox_median_summer(idx_nox_summer(1:end-1),1),'filled');
title('BVOC vs CS summer 2014')
xlabel('Monoterpene [ppb]','FontSize',16,'FontWeight','bold','Color','k')
ylabel('CS [s^-^1]','FontSize',16,'FontWeight','bold','Color','k')
set(gca,'FontSize',14,'FontWeight','bold','Xscale','log','yscale','log')
...
cb = colorbar;
ylabel(cb,'NO_x [ppb]','fontsize',16,'fontweight','b')
% [r_summer_NOX,p_summer_NOX]=corr(log10(mono_median_h(idx_nox_summer,1)),log10(median_cs(idx_nox_summer+1,1)),'rows','complete'); %r is the linear correlation coefficient, p is the p-value 
[r_summer_NOX,p_summer_NOX]=corr(log10(mono_median_summer(idx_nox_summer(1:end-1),1)),log10(median_cs_summer(idx_nox_summer(2:end),1)),'rows','complete'); %r is the linear correlation coefficient, p is the p-value 
