function [CS, CS_prime, varargout] = CS_general(Dp, N, T, alpha)
 ...
 % setting the constants %%%%%%%%%%%%%%%%%%%%%%%%%%%%
         ...
         Mx    = 63.01;     % g/mol    % molar mass of HNO3
         Mair  = 28.965;    % g/mol    %  - " -        air
         Pr    = 1.;        % atm      % pressure
         Dair  = 19.7;      % ??       % diffusion volume of air
         Dx    = 200;     % ??       % diffusion volume of (H2SO4)???HNO3probably
         k     = 8314.51;   % actually R

 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

 %R = Dp./2;   % in malte calculations we already use radius
 R = Dp;
 Temp = T;       
